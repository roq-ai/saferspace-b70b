...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'report.create': {
    roles: ['admin', 'investigator', 'resolver'],
    key: 'new-report-created',
    tenantPath: ['organization', 'user', 'report'],
    userPath: [],
  },
  'report.update': {
    roles: ['admin', 'user'],
    key: 'report-status-updated',
    tenantPath: ['organization', 'user', 'report'],
    userPath: [],
  },
  'feedback.create': {
    roles: ['admin'],
    key: 'new-feedback-received',
    tenantPath: ['organization', 'user', 'feedback'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['admin', 'user', 'investigator', 'resolver'];
